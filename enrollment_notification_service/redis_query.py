...
from enrollment_notification_service.models import QueryStatus, SubscriptionRequest, UnSubscribeRequest, SubscriptionCourse, ListSubscriptionResponse
...
def list_subscriptions(student_id: str, redis_client: Redis):
    ...
    try:
        ...
        for key in list_keys:
            ...
            subscription_courses.append(SubscriptionCourse(course_code=course_code,
            email=email, webhook_url=webhook_url)) #type:ignore
    except Exception as e:
